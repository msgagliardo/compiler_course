...
class S2
{
  public static void main(String[] args) throws
                                             IOException
  {
    System.out.println("S2 compiler written by Marc Gagliardo");
    ...
    outFile.println("; from S2 compiler written by Marc Gagliardo");
...
class S2Parser implements S2Constants
{
  ...
  private void printArg()
  {
      ...
      case STRING:
        ...
        break;
      default:
        throw genEx("Expecting String, expression, or empty");
